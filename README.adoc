...
NOTE: To generate James keystore this way, you need to have keytool installed.

Be sure that the password you provide matches with James configuration. You will 
find it in james-parent project, in the destination/conf directory. Concerned files are 
