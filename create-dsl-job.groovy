...
dslBuilder = new ExecuteDslScripts(scriptLocation=new ExecuteDslScripts.ScriptLocation(value = "false", targets="build-pr-from-github,build-linagora-james-project-trunk", scriptText=""), ignoreExisting=false, removedJobAction=RemovedJobAction.DISABLE);
