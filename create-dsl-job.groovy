...
dslBuilder = new ExecuteDslScripts(scriptLocation=new ExecuteDslScripts.ScriptLocation(value = "false", targets="build-pr-from-github,build-james-project-script", scriptText=""), ignoreExisting=false, removedJobAction=RemovedJobAction.DISABLE);
